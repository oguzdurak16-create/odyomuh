...
export const metadata = {
  ...
  openGraph: { locale: 'en_US', type: 'website', siteName: `${site.name} English`, title: 'ODYOMUH English | History, Archaeology and Ancient Mysteries', description: siteDescription, url: `${siteUrl}/en`, images: [{ url: generatedArt.globalHistoryHero, width: 1672, height: 941, alt: 'ODYOMUH English history and archaeology archive' }] },
...
export default function EnglishRootLayout({ children }) {
  ...
  return <html lang="en" suppressHydrationWarning style={{ '--font-cinzel': '"Cinzel", Georgia, serif', '--font-merriweather': '"Merriweather", Georgia, serif', '--font-inter': '"Inter", Arial, sans-serif' }}>
    <head><script dangerouslySetInnerHTML={{ __html: themeBootstrap }} /><script id="odyomuh-consent-default-head-en" src="/consent-default.js" /><script id="odyomuh-adsense-script-en" async src="https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js?client=ca-pub-4491868887846507" crossOrigin="anonymous" /><link rel="preconnect" href="https://fonts.googleapis.com" /><link rel="preconnect" href="https://fonts.gstatic.com" crossOrigin="anonymous" /><link href="https://fonts.googleapis.com/css2?family=Cinzel:wght@700;900&family=Inter:wght@400;600;700&family=Merriweather:wght@400;700&display=swap" rel="stylesheet" /><link rel="alternate" type="application/rss+xml" title="ODYOMUH English RSS" href="/en/feed.xml" /><script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(jsonLd) }} /></head>
    <body><AnalyticsBootstrap /><SiteChrome site={{ name: site.name, description: siteDescription }} pages={[]} labels={[]}><ConsentRestore />{children}<AdSlot slot={process.env.NEXT_PUBLIC_ADSENSE_CONTENT_SLOT} label="Advertisement" afterSelector=".post-meta-info" /></SiteChrome></body>
  </html>;
}
